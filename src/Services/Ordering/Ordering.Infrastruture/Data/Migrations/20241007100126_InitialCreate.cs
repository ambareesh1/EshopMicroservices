    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderName", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderNameId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ...
                    ShippingAddress_Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Orders_OrderName_OrderNameId",
                        column: x => x.OrderNameId,
                        principalTable: "OrderName",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
